...
if [ -z "$target" ]
  then
  	if [ ! -z "$showHelp" ]
	     ...
	     echo -e "\t./build.sh asb|administration-bus|administration-service-bus ------------------- builds 'Administration-Service-Broker' application."
	     echo -e "\t./build.sh csb|customer-roker|customer-service-broker -------------------------- builds 'Customer-Service-Broker' application."
	     ...
	     echo -e "\t./build.sh cim|containerized-infrastructure-manager|container-manager ---------- builds 'SONAr-Containerized-Infrastructure-Manager' application."
	     echo -e "\t./build.sh dhcp|dhcp-server ---------------------------------------------------- builds 'SONAr-DHCP-Server' application."
