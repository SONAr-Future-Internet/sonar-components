...
if [ 	-z "$target" ]
  then
     echo -e "Usage:"
     echo -e "\t./build.sh ascoe|alarms|alarms-collector|alarms-self-collector-entity --------------- runs 'Alarms Self-Collector Entity' application."
     echo -e "\t./build.sh mscoe|metrics|metrics-collector|metrics-self-collector-entity ------------ runs 'Metrics Self-Collector Entity' application."
     echo -e "\t./build.sh sscoe|samples|samples-collector|samples-self-collector-entity ------------ runs 'Samples Self-Collector Entity' application."
     echo -e "\t./build.sh tscoe|toplogy|topology-collector|topology-self-collector-entity ---------- runs 'Topology Self-Collector Entity' application."
     echo -e "\t./build.sh lscoe|logs|logs-collector|logs-self-collector-entity --------------------- runs 'Logs Self-Collector Entity' application."
     echo -e "\t./build.sh dsle|diagnosis|diagnosis-learning|diagnosis-self-learning-entity --------- runs 'Diagnosis Self-Learning Entity' application."
     echo -e "\t./build.sh tsle|tunning|tunning-learning|tunning-self-learning-entity --------------- runs 'Tunning Self-Learning Entity' application."
     echo -e "\t./build.sh psle|prediction|prediction-learning|prediction-self-learning-entity ------ runs 'Prediction Self-Learning Entity' application."
     echo -e "\t./build.sh rsle|rating|rating-learning|rating-self-learning-entity ------------------ runs 'Rating Self-Learning Entity' application."
     echo -e "\t./build.sh isle|intent|intent-learning|intent-self-learning-entity ------------------ runs 'Intent Self-Learning Entity' application."
     echo -e "\t./build.sh sce|configuration|configuration-entity|self-configuration-entity --------- runs 'Self-Configuration Entity' application."
     echo -e "\t./build.sh she|healing|healing-entity|self-healing-entity --------------------------- runs 'Self-Healing Entity' application."
     echo -e "\t./build.sh sme|management|management-entity|self-management-entity ------------------ runs 'Self-Management Entity' application."
     echo -e "\t./build.sh soe|optimization|optimization-entity|self-optimization-entity ------------ runs 'Self-Optimization Entity' application."
     echo -e "\t./build.sh sple|planning|planning-entity|self-planning-entity ----------------------- runs 'Self-Planning Entity' application."
     echo -e "\t./build.sh spe|protection|protection-entity|self-protection-entity ------------------ runs 'Self-Protection Entity' application."
     echo -e "\t./build.sh asb|administration-bus|administration-service-bus ------------------------ runs 'Administration-Service-Manager' application."
     echo -e "\t./build.sh csb|customer-bus|customer-service-bus ------------------------------------ runs 'Customer-Service-Manager' application."
     echo -e "\t./build.sh isb|integration-bus|integration-service-bus ------------------------------ runs 'Integration-Service-Manager' application."
     echo -e "\t./build.sh nem|event-manager|network-event-manager ---------------------------------- runs 'Network-Event-Manager' application."
     echo -e "\t./build.sh abm|boot-manager|auto-boot-manager --------------------------------------- runs 'Auto-Boot-Manager' application."
     echo -e "\t./build.sh cpi|interceptor|control-plane-interceptor -------------------------------- runs 'Control-Plane-Interceptor' application."
