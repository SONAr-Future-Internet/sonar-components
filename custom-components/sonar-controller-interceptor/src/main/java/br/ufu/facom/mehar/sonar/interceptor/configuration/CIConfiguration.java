package br.ufu.facom.mehar.sonar.interceptor.configuration;
...
public class CIConfiguration {
	...
	public String[] getSDNSouthSeeds() {
		return CIConfiguration.sdnSouthSeeds.split(",");
	}
	
	public String getStrategy() {
		return CIConfiguration.sdnStrategy;
	}
	
	//Setters
	public static void setSDNSouthSeeds(String sdnSouthSeed) {
		CIConfiguration.sdnSouthSeeds = sdnSouthSeed;
	}
	
	public static void setStrategy(String sdnStrategy) {
		CIConfiguration.sdnStrategy = sdnStrategy;
	}
